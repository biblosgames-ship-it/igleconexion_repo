...
export default function SuperAdminPage() {
  ...
  const allTabs = [
    ...
    { id: 1, label: "Mi Iglesia", title: "Mi Iglesia y Configuración General", description: "Gestiona los datos, colores, agenda y recursos disponibles para los miembros.", icon: "/Iconos/Identidad 2.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 2, label: "Sociedades", title: "Estructura de Sociedades y Grupos", description: "Crea las Sociedades principales y subdivídelas en Grupos de Conexión.", icon: "/Iconos/Sociedad.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 3, label: "Etapas de Crecimiento", title: "Estructura de la Ruta de Crecimiento", description: "Configura las Etapas del camino de crecimiento del miembro y mapea sus procesos.", icon: "/Iconos/Etapas.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 4, label: "Módulos de Procesos", title: "Catálogo de Módulos y Procesos", description: "Crea los Módulos correspondientes a los departamentos de trabajo y registra las tareas.", icon: "/Iconos/Proceso.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 5, label: "Liderazgo y Permisos", title: "Consola de Liderazgo y Permisos (RBAC)", description: "Organiza y clasifica a los líderes por áreas, personaliza sus categorías y crea sus directivas.", icon: "/Iconos/servicio.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 6, label: "Agenda y Eventos", title: "Agenda de Actividades de la Iglesia", description: "Programa actividades semanales regulares y eventos especiales.", icon: "/Iconos/Agenda.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 7, label: "Miembros", title: "Administración General de Miembros", description: "Busca, edita y gestiona la información y etapas de crecimiento de todos los miembros registrados en la iglesia.", icon: "/Iconos/Miembros.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    ...
    { id: 10, label: "Finanzas", title: "Módulo de Finanzas", description: "Gestión completa de ingresos, egresos, fondos y nómina de la iglesia.", icon: "/Iconos/finanzas.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 11, label: "Pastoral", title: "Módulo Pastoral", description: "Gestión de peticiones de oración y bitácora de seguimiento pastoral.", icon: "/Iconos/pastoral.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    ...
    { id: 14, label: "Eventos y Cursos", title: "Gestión de Eventos y Cursos", description: "Administra eventos, cursos de crecimiento y check-in de asistencia.", icon: "/Iconos/Ebento.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 16, label: "Formularios y Encuestas", title: "Encuestas y Formularios", description: "Crea y gestiona formularios, encuestas y recopila respuestas de los miembros.", icon: "/Iconos/Formulario.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] },
    { id: 8, label: "Soporte Técnico", title: "Soporte Técnico y Mensajería", description: "Chatea directamente con nuestro equipo de soporte técnico para resolver dudas o problemas.", icon: "/Iconos/soporte.png", roles: ["SUPERADMIN", "ADMIN_IGLESIA"] }
  ];
    ...
    <div style={{ display: 'contents' }}>
      ...
      <div className={styles.adminMainContent}>
        ...
        <header className={styles.adminTopNavbar}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
            ...
            <Link href="/perfil" style={{ fontSize: '0.8rem', fontWeight: 600, color: '#475569', textDecoration: 'none', background: '#f1f5f9', padding: '0.35rem 0.75rem', borderRadius: '6px', display: 'inline-flex', alignItems: 'center', gap: '0.35rem' }}>
              <img src="/Iconos/ID.png" alt="Perfil" style={{ width: 14, height: 14, objectFit: 'contain' }} /> Mi Perfil
            </Link>
          </div>
        </header>
            ...
            <div>
              ...
              {showPromoteModal && (
                <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem' }}>
                  <div style={{ backgroundColor: 'white', borderRadius: '12px', maxWidth: '480px', width: '100%', padding: '1.5rem', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.15)' }}>
        ...
        <nav className={styles.mobileBottomBar}>
          ...
          >
            <span className={styles.mobileBottomBarIcon}>
              <img src="/Iconos/Miembros.png" alt="Miembros" style={{ width: 26, height: 26, objectFit: 'contain' }} />
            </span>
          ...
          >
            <span className={styles.mobileBottomBarIcon}>
              <img src="/Iconos/finanzas.png" alt="Finanzas" style={{ width: 26, height: 26, objectFit: 'contain' }} />
            </span>
          ...
          >
            <span className={styles.mobileBottomBarIcon}>
              <img src="/Iconos/pastoral.png" alt="Pastoral" style={{ width: 26, height: 26, objectFit: 'contain' }} />
            </span>
