...
CREATE TABLE "GrupoConexion" (
    ...
    "sexo_requerido" TEXT,
    CONSTRAINT "GrupoConexion_iglesia_id_fkey" FOREIGN KEY ("iglesia_id") REFERENCES "Iglesia" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_Persona" ("createdAt", "etapa_id", "fecha_nacimiento", "foto_url", "id", "iglesia_id", "medio_relacion", "nombre", "telefono", "updatedAt", "whatsapp") SELECT "createdAt", "etapa_id", "fecha_nacimiento", "foto_url", "id", "iglesia_id", "medio_relacion", "nombre", "telefono", "updatedAt", "whatsapp" FROM "Persona";
DROP TABLE "Persona";
